...
for (const entry of entrypoints) {
  test(`Load Example control uses tighter width on ${entry}`, async ({ page }) => {
    ...
    try {
      ...
      const width = await page.locator('#loadExampleSelect').evaluate((el) => Math.round(el.getBoundingClientRect().width));
