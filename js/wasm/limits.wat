...
(module
  ...
  (func (export "GLIMS")
      ...
      (then
        ...
        (block $ob_done
          (loop $ob_loop
            ...
            (call $store_f32_at (local.get $pts_ptr) (i32.const 0)
              (call $load_f32_at (local.get $rob_ptr) (i32.add (i32.mul (local.get $n) (i32.const 3)) (i32.const 0))))
            (call $store_f32_at (local.get $pts_ptr) (i32.const 1)
              (call $load_f32_at (local.get $rob_ptr) (i32.add (i32.mul (local.get $n) (i32.const 3)) (i32.const 1))))
            (call $store_f32_at (local.get $pts_ptr) (i32.const 2)
              (call $load_f32_at (local.get $rob_ptr) (i32.add (i32.mul (local.get $n) (i32.const 3)) (i32.const 2))))

            (if (i32.ne (local.get $lproj) (i32.const 0))
              (then (call $VIEWPROJ (local.get $pts_ptr) (i32.const 1) (local.get $view_ptr))))
            ...
            (block $k_done3
              (loop $k_loop3
                ...
                (local.set $v1 (call $load_f32_at (local.get $pts_ptr) (local.get $k)))
                (call $store_f32_at (local.get $xyzmin_ptr) (local.get $k)
                  (f32.min (call $load_f32_at (local.get $xyzmin_ptr) (local.get $k)) (local.get $v1)))
                (call $store_f32_at (local.get $xyzmax_ptr) (local.get $k)
                  (f32.max (call $load_f32_at (local.get $xyzmax_ptr) (local.get $k)) (local.get $v1)))
                (local.set $k (i32.add (local.get $k) (i32.const 1)))
                (br $k_loop3)
              )
            )
    ...
    (if (i32.eq (local.get $lset) (i32.const 0))
      (then
        (call $store_f32_at (local.get $xyzmin_ptr) (i32.const 0) (f32.const -1))
        (call $store_f32_at (local.get $xyzmin_ptr) (i32.const 1) (f32.const -1))
        (call $store_f32_at (local.get $xyzmin_ptr) (i32.const 2) (f32.const -1))
        (call $store_f32_at (local.get $xyzmax_ptr) (i32.const 0) (f32.const 1))
        (call $store_f32_at (local.get $xyzmax_ptr) (i32.const 1) (f32.const 1))
        (call $store_f32_at (local.get $xyzmax_ptr) (i32.const 2) (f32.const 1))
      )
    )
  )
